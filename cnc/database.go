...
func NewDatabase(dbAddr string, dbUser string, dbPassword string, dbName string) *Database {
    ...
    fmt.Println("Started nbot v2 cnc | t.me/krtraffic | this cnc is backdoored and monitorized in case of code leak. (ALSO DMCA PROTECTED)")

    fmt.Println("By screening this cnc, you agree to my tos (leaking & modifying / selling this is forbidden)")
    return &Database{db}
}
